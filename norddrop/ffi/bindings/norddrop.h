 ...
 *   , is_deleted INTEGER NOT NULL DEFAULT FALSE CHECK (is_deleted IN (FALSE, TRUE)));
 ...
 *     bytes INT NOT NULL,
 *     created_at TIMESTAMP NOT NULL DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%f', 'NOW')), is_deleted INTEGER NOT NULL DEFAULT FALSE CHECK (is_deleted IN (FALSE, TRUE)),
 *     FOREIGN KEY(transfer_id) REFERENCES transfers(id) ON DELETE CASCADE ON UPDATE CASCADE
 *     CHECK(bytes >= 0)
 ...
 *     bytes INT NOT NULL,
 *     created_at TIMESTAMP NOT NULL DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%f', 'NOW')),
 *     checksum BLOB DEFAULT NULL, is_deleted INTEGER NOT NULL DEFAULT FALSE CHECK (is_deleted IN (FALSE, TRUE)),
 *     FOREIGN KEY(transfer_id) REFERENCES transfers(id) ON DELETE CASCADE ON UPDATE CASCADE
 *     CHECK(bytes >= 0)
 *     UNIQUE(transfer_id, path_hash)
 *   );
 ...
 *     id INTEGER PRIMARY KEY AUTOINCREMENT,
 *     path_id INTEGER NOT NULL,
 *     created_at TIMESTAMP NOT NULL DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%f', 'NOW')), base_dir TEXT NOT NULL DEFAULT '',
 ...
 *     path_id INTEGER NOT NULL,
 *     by_peer INTEGER NOT NULL,
 *     created_at TIMESTAMP NOT NULL DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%f', 'NOW')), bytes_received INTEGER NOT NULL DEFAULT 0,
 *     FOREIGN KEY(path_id) REFERENCES incoming_paths(id) ON DELETE CASCADE ON UPDATE CASCADE
 *   );
 ...
 *     path_id INTEGER NOT NULL,
 *     by_peer INTEGER NOT NULL,
 *     created_at TIMESTAMP NOT NULL DEFAULT(STRFTIME('%Y-%m-%d %H:%M:%f', 'NOW')), bytes_sent     INTEGER NOT NULL DEFAULT 0,
 *     FOREIGN KEY(path_id) REFERENCES outgoing_paths(id) ON DELETE CASCADE ON UPDATE CASCADE
 *   );
 ...
 * ````
 */
char *norddrop_get_transfers_since(const struct norddrop *dev,
