...
scenarios = [
    ...
    # TODO: Currently disabled as they are guaranteed to fail and are slowing down the pipelines
    #       Re-enble these tests when fixing the chunking issue
    # Scenario(
    #     "scenario21-1",
    ...
    Scenario(
        "scenario31-3",
        "Remove file on sending side without rejecting it first. Expect error and file present in JSON output",
        {
            "ren": ActionList(
                [
                    action.Start("172.20.0.5", dbpath="/tmp/db/31-1-ren.sqlite"),
